...
var adopt = __toESM(require("./cli/adopt.js"), 1);
import_env.default.loadEnvConfig(import_node_process.default.cwd(), void 0, import_logger.default);
(0, import_yargs.default)(import_node_process.default.argv.slice(2)).command(init).command(sync).command(adopt).demandCommand().help().argv;
