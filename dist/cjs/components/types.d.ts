...
export type VideoProps<TPlaybackId = string | undefined> = TPlaybackId extends string ? Omit<Partial<MuxVideoProps> & PlayerProps, 'src' | 'poster'> & SuperVideoProps & {
    playbackId?: TPlaybackId;
} & {
    style?: CSSPropertiesWithVars;
} : Omit<NativeVideoProps & PlayerProps, 'src' | 'poster'> & SuperVideoProps & {
